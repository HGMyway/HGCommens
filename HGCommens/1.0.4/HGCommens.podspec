...
# pod repo push HGCommens HGCommens.podspec --allow-warnings --sources='https://github.com/CocoaPods/Specs.git'
...
#git remote add origin https://github.com/HGMyway/HGCommens.git
